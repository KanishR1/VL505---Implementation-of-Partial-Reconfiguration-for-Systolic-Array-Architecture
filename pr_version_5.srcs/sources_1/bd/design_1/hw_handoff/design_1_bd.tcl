...
# module references:
# address_logic, input_formatting, systolic_unit, top
...
proc create_root_design { parentCell } {
  ...
  # Create instance: address_logic_0, and set properties
  set block_name address_logic
  set block_cell_name address_logic_0
  if { [catch {set address_logic_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $address_logic_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: input_formatting_0, and set properties
  set block_name input_formatting
  set block_cell_name input_formatting_0
  if { [catch {set input_formatting_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $input_formatting_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: myip_custom_mem_0, and set properties
  set myip_custom_mem_0 [ create_bd_cell -type ip -vlnv user.org:user:myip_custom_mem:1.0 myip_custom_mem_0 ]
  ...
  # Create instance: systolic_unit_0, and set properties
  set block_name systolic_unit
  set block_cell_name systolic_unit_0
  if { [catch {set systolic_unit_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $systolic_unit_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins myip_custom_mem_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins address_logic_0/clk] [get_bd_pins input_formatting_0/i_clk] [get_bd_pins myip_custom_mem_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins systolic_unit_0/i_clk] [get_bd_pins top_0/i_clk]
  connect_bd_net -net Net1 [get_bd_pins address_logic_0/done] [get_bd_pins input_formatting_0/i_enable] [get_bd_pins myip_custom_mem_0/done] [get_bd_pins system_ila_0/probe0] [get_bd_pins systolic_unit_0/i_enable] [get_bd_pins top_0/done]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets Net1]
  connect_bd_net -net Net2 [get_bd_pins address_logic_0/pl_dout] [get_bd_pins myip_custom_mem_0/pl_dout] [get_bd_pins top_0/pl_data]
  connect_bd_net -net address_logic_0_pl_addr_logic [get_bd_pins address_logic_0/pl_addr_logic] [get_bd_pins myip_custom_mem_0/pl_addr_logic]
  connect_bd_net -net address_logic_0_pl_en [get_bd_pins address_logic_0/pl_en] [get_bd_pins myip_custom_mem_0/pl_en]
  connect_bd_net -net address_logic_0_pl_wr_en [get_bd_pins address_logic_0/pl_wr_en] [get_bd_pins myip_custom_mem_0/pl_wr_en]
  connect_bd_net -net input_formatting_0_o_compute [get_bd_pins input_formatting_0/o_compute] [get_bd_pins systolic_unit_0/i_data_valid]
  connect_bd_net -net input_formatting_0_o_left_inputs [get_bd_pins input_formatting_0/o_left_inputs] [get_bd_pins systolic_unit_0/left_inputs]
  connect_bd_net -net o_ccu_output1 [get_bd_pins system_ila_0/probe3] [get_bd_pins systolic_unit_0/o_ccu_output1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets o_ccu_output1]
  connect_bd_net -net o_ccu_output2 [get_bd_pins system_ila_0/probe1] [get_bd_pins systolic_unit_0/o_ccu_output2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets o_ccu_output2]
  connect_bd_net -net o_ccu_output3 [get_bd_pins system_ila_0/probe2] [get_bd_pins systolic_unit_0/o_ccu_output3]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets o_ccu_output3]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins myip_custom_mem_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net top_0_pl_act_data [get_bd_pins input_formatting_0/i_data_bram] [get_bd_pins top_0/pl_act_data]
  connect_bd_net -net top_0_top_inputs [get_bd_pins systolic_unit_0/top_inputs] [get_bd_pins top_0/top_inputs]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_custom_mem_0/S00_AXI/S00_AXI_reg] SEG_myip_custom_mem_0_S00_AXI_reg
