...
################################################################
# This is a generated script based on design: custom_mem
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net address_logic_0_pl_addr_logic [get_bd_pins address_logic_0/pl_addr_logic] [get_bd_pins myip_custom_mem_0/pl_addr_logic] [get_bd_pins system_ila_0/probe2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets address_logic_0_pl_addr_logic]
  connect_bd_net -net address_logic_0_pl_en [get_bd_pins address_logic_0/pl_en] [get_bd_pins myip_custom_mem_0/pl_en] [get_bd_pins system_ila_0/probe3]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets address_logic_0_pl_en]
  connect_bd_net -net address_logic_0_pl_wr_en [get_bd_pins address_logic_0/pl_wr_en] [get_bd_pins myip_custom_mem_0/pl_wr_en] [get_bd_pins system_ila_0/probe4]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets address_logic_0_pl_wr_en]
  connect_bd_net -net myip_custom_mem_0_done [get_bd_pins address_logic_0/done] [get_bd_pins myip_custom_mem_0/done] [get_bd_pins system_ila_0/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets myip_custom_mem_0_done]
  connect_bd_net -net myip_custom_mem_0_pl_dout [get_bd_pins address_logic_0/pl_dout] [get_bd_pins myip_custom_mem_0/pl_dout] [get_bd_pins system_ila_0/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets myip_custom_mem_0_pl_dout]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins address_logic_0/clk] [get_bd_pins myip_custom_mem_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
