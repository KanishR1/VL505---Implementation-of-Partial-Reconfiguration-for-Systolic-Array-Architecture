...
HD_PWD='/home/jay/Kanish/custom_memory/custom_memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_mem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_mem_wrapper.tcl
