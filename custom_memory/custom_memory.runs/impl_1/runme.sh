...
HD_PWD='/home/jay/Kanish/custom_memory/custom_memory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_mem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source custom_mem_wrapper.tcl -notrace
