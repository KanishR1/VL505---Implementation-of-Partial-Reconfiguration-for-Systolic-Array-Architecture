...
HD_PWD='/home/jay/Kanish/custom_memory/custom_memory.runs/custom_mem_system_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_mem_system_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_mem_system_ila_0_0.tcl
